...
export default function AboutMe({ setTarget, language }) {
  ...
  return (
    <div className="h-full w-full relative bg-neutral-200 select-none ">
      ...
      <div className="absolute w-full h-full text-xl p-4 flex flex-col items-center justify-between border gap-2 font-mono">
        ...
        <div className="w-full text-center items-center justify-center flex flex-col font-mono gap-4 p-2">
